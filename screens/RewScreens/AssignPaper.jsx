...
import { Linking, StyleSheet, StatusBar, Text, Dimensions, TextInput, TouchableOpacity, View, RefreshControl, ToastAndroid, Animated, ScrollViewComponent } from 'react-native';
                        ...
                        ((pointer == -1) ? true : (index == pointer)) ?
                            <View key={index} style={[styles.subCard, {
                                ...
                                <Text style={styles.textSetting}>
                                    ...
                                    <Text style={{fontWeight:'bold' }}>{i.paperID}</Text>
                                    </Text>
                                <Text style={styles.textSetting}>
                                ...
                                <Text style={styles.textSetting}>
                                    ...
                                    <Text style={{ }}>{i.abstract}</Text></Text>
